...
export default function AgentsHeader({ onSearch, onCreateAgent }: Props) {
      ...
      <div className="relative group">
        ...
        <div className="relative flex items-center bg-white/5 backdrop-blur-xl border border-cyan-400/20 rounded-2xl px-4 py-4">
          ...
          <button
            ...
            className="ml-4 flex items-center gap-2 bg-cyan-500/10 hover:bg-cyan-500/20 border border-cyan-400/30 px-4 py-2 rounded-xl text-cyan-300 text-sm transition shadow-[0_0_15px_rgba(0,255,255,0.3)]"
          >
            <Plus size={16} />
            Create Agent
          </button>
